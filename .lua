if _G.MainScriptLoaded then
 ...
 local whitelist = { 4649811121, 4714810176, 7671996882,
 } 
 ...
 if not isWhitelisted then
     ...
     player:Kick("🚫 You are not allowed to use this script/ ممنوع تستخدم هذا السكربت")
     return
 end
...
local window = library:AddWindow("F-518, Nour, Naif | The Best Friends Ever", {
    main_color = Color3.fromRGB(0, 0, 0), -- Custom black color
